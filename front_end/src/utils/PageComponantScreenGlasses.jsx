...
import { LeftSideS } from './compoScreenhelper/LeftSideS'
import { RightSideS } from './compoScreenhelper/RightSideS'

function PageComponantScreenGlasses() {
  return (
    <>
...
export {PageComponantScreenGlasses}